...
package ahwan0m.site.amvideodownloader.download_feature;
...
import ahwan0m.site.amvideodownloader.AMdwApp;
...
public class DownloadNotifier {
    ...
    private class DownloadingRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                NB = new Notification.Builder(AMdwApp.getInstance().getApplicationContext(), "download_01")
                        .setStyle(new Notification.BigTextStyle());
            } else {
                NB = new Notification.Builder(AMdwApp.getInstance().getApplicationContext());
            }
            NB.setContentTitle("Downloading " + filename)
                    .setSmallIcon(R.mipmap.ic_launcher_round)
                    .setLargeIcon(BitmapFactory.decodeResource(AMdwApp.getInstance()
            ...
            if (downloadServiceIntent.getBooleanExtra("chunked", false)) {
                ...
                String downloaded;
                if (file.exists()) {
                    downloaded = android.text.format.Formatter.formatFileSize(AMdwApp.getInstance
                ...
                String downloaded = android.text.format.Formatter.formatFileSize(AMdwApp
                        .getInstance().getApplicationContext(), file.length());
                String total = android.text.format.Formatter.formatFileSize(AMdwApp.getInstance()
    ...
    DownloadNotifier(Intent downloadServiceIntent) {
        ...
        notificationManager = (NotificationManager) AMdwApp.getInstance().getApplicationContext().getSystemService
    ...
    void notifyDownloadFinished() {
        ...
        Notification.Builder NB;
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            NB = new Notification.Builder(AMdwApp.getInstance().getApplicationContext(), "download_02")
                    .setTimeoutAfter(1500)
                    .setContentTitle("Download Finished")
                    .setContentText(filename)
                    .setSmallIcon(R.mipmap.ic_launcher_round)
                    .setLargeIcon(BitmapFactory.decodeResource(AMdwApp.getInstance().getApplicationContext().getResources(),
