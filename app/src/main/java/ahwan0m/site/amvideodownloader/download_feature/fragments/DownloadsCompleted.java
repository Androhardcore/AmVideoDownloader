...
import ahwan0m.site.amvideodownloader.download_feature.lists.CompletedVideos;
import ahwan0m.site.amvideodownloader.utils.RenameDialog;
import ahwan0m.site.amvideodownloader.utils.Utils;

public class DownloadsCompleted extends AMdwFragment implements DownloadsInProgress.OnAddDownloadedVideoToCompletedListener {
    private View view;
    ...
    public void onResume() {
        ...
        completedVideos.save(AMdwApp.getInstance().getApplicationContext());
        onNumDownloadsCompletedChangeListener.onNumDownloadsCompletedChange();
    }
