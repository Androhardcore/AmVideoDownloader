...
import ahwan0m.site.amvideodownloader.AMdwActivity;
...
import ahwan0m.site.amvideodownloader.WebConnect;
import ahwan0m.site.amvideodownloader.bookmarks_feature.AddBookmarkDialog;
import ahwan0m.site.amvideodownloader.bookmarks_feature.Bookmark;
import ahwan0m.site.amvideodownloader.history_feature.HistorySQLite;
import ahwan0m.site.amvideodownloader.history_feature.VisitedPage;
import ahwan0m.site.amvideodownloader.utils.Utils;

public class BrowserWindow extends AMdwFragment implements View.OnTouchListener, View
        .OnClickListener, AMdwActivity.OnBackPressedListener, View.OnLongClickListener {
    private String url;
    private View view;
            ...
            page.setWebViewClient(new WebViewClient() {//it seems not setting webclient, launches
                ...
                public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && getLMvdActivity() !=
                            null) {
                        if (AMdwApp.getInstance().getSharedPreferences("settings", 0).getBoolean(getString
    ...
    private void updateFoundVideosBar() {
        ...
        final ForegroundColorSpan fcs = new ForegroundColorSpan(AMdwApp.getInstance()
