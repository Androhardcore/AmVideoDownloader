    ...
    class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.VideoItem> {
        ...
        class VideoItem extends RecyclerView.ViewHolder implements CompoundButton
            ...
            void startDownload() {
                ...
                Intent downloadService = AMdwApp.getInstance().getDownloadService();
                AMdwApp.getInstance().stopService(downloadService);
                ...
                AMdwApp.getInstance().startService(downloadService);
                videos.remove(getAdapterPosition());
                expandedItem = -1;
                notifyDataSetChanged();
                onItemDeleted();
